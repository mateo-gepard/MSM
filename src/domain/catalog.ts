...
export const PACKAGE_CATALOG: readonly Package[] = [
  {
    ...
    priceCents: 0,
    features: [
      'Kostenlose Probestunde über 60 Minuten',
...
export const TUTOR_CATALOG: readonly Tutor[] = [
  {
    ...
    achievements: [
      '1. Preis bei der Mathematikolympiade',
  ...
  },
  {
    ...
    achievements: [
      'Erfolgreiche Teilnahme an einer internationalen Physikolympiade',
      'Leitet einen Robotikkurs an seiner Schule',
      'Langjährige Erfahrung mit CAD, 3D Druck und Programmieren',
    ],
    image: '/tutors/Mateo.JPG',
    bio: 'Hobbyingenieur mit Begeisterung für Physik',
  ...
  },
  {
    ...
    achievements: [
      ...
      'Frühstudium in Luftfahrt und Raumfahrttechnik',
    ],
  ...
  },
  {
    ...
    bio: 'Physiker, talentierter Programmierer und Robotikexperte',
